...
//pres ctrl shift F
    private void showImage(String url){
        if(url != null && !url.isEmpty()){
            ...
            url = FirebaseUtil.encodeValue(url); //"https://firebasestorage.googleapis.com/v0/b/travelmantics-56313.appspot.com/o/"+url+"?alt=media&token=011a13ad-ca4d-4b1e-bf02-b3b6cdedd0fa"
            Picasso.get()
                    .load("https://firebasestorage.googleapis.com/v0/b/travelmantics-56313.appspot.com/o/"+url+"?alt=media&token=011a13ad-ca4d-4b1e-bf02-b3b6cdedd0fa")
